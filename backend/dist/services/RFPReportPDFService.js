        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (tech?.topMatches?.length) {
                tech.topMatches.forEach((m, i) => {
                    doc
                        .font("Helvetica-Bold")
                        .text(`${i + 1}. ${m.sku}  (Score: ${m.matchScore}%, Confidence: ${Math.round((m.confidence ?? 0) * 100)}%)`)
                        .font("Helvetica");
                    if (m.risks?.length) {
                        doc
                            .fontSize(10)
            ...
            doc.text(`Total Bid Price: $${pricing?.pricing?.totalBidPrice ?? "N/A"}`);
            ...
            const footer = () => {
                ...
                doc
                    .fontSize(9)
                    .fillColor("gray")
                    .text(`Generated by RFP Automation Platform • Page ${pageNumber}`, 50, doc.page.height - 40, { align: "center" })
                    .fillColor("black");
            };
            footer();
