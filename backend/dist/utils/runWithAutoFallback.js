export async function runWithAutoFallback({ primaryCall, fallbackCall, confidenceThreshold = 0.6, }) {
    try {
        const primaryResult = await primaryCall();
        if (primaryResult?.confidence !== undefined &&
...
//# sourceMappingURL=runWithAutoFallback.js.map